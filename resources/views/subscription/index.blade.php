    ...
    <script>
        ...
        function renderTable(subscriptions) {
            ...
            subscriptions.forEach((sub) => {
                ...
                const disabledClass = isDismantle
                ...
                <td class="py-4 px-6 text-center relative">
                    ...
                    <div id="dropdown-${sub.id}" class="hidden absolute right-8 top-10 w-48 bg-white border border-gray-100 rounded-lg shadow-lg z-50 text-left py-2">
                        ...
                        <button 
                            ...
                            class="w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 flex items-center ${disabledClass}">
                        ...
                        <button 
                            onclick="changeStatus(${sub.id}, 'inactive')" 
                            class="w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 flex items-center ${disabledClass}">
                        ...
                        <button 
                            onclick="changeStatus(${sub.id}, 'trial')" 
                            class="w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 flex items-center ${disabledClass}">
                        ...
                        <button 
                            onclick="changeStatus(${sub.id}, 'isolir')" 
                            class="w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 flex items-center ${disabledClass}">
                        ...
                        <button 
                            onclick="changeStatus(${sub.id}, 'dismantle')" 
